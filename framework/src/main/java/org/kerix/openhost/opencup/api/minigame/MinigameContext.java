...
public interface MinigameContext {
    ...
    /**
     * Explicit score submission API. Useful when a minigame wants an auditable
     * score event instead of directly mutating GamePlayer session points.
     */
    void submitScore(ScoreSubmission submission);

    /** Score submissions recorded for this session. */
    List<ScoreSubmission> getScoreSubmissions();
