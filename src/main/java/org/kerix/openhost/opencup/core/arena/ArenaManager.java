...
public final class ArenaManager implements Startable {
    ...
    public Arena checkout(String arenaId) {
        ...
        if (arena == null) throw new NoSuchElementException("Unknown arena: " + arenaId);
        if (arena.isOccupied()) throw new IllegalStateException(
    ...
    public boolean isAvailable(String arenaId) {
        ...
        return a != null && !a.isOccupied();
    }

    public Set<String> getRegisteredIds() { return Collections.unmodifiableSet(arenas.keySet()); }
